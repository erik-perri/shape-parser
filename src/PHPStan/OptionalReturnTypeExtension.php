...
class OptionalReturnTypeExtension implements DynamicMethodReturnTypeExtension
{
    ...
    {
        return $methodReflection->getName() === 'optional';
    }
    ...
    public function getTypeFromMethodCall(
        ...
        return new GenericObjectType(OptionalParser::class, [$innerType]);
    }
